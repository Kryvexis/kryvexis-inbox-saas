        ...
        <section className="mt-16 grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            <h1 className="text-5xl font-semibold tracking-tight">
              A customer workspace your team can actually use.
            </h1>
            <p className="mt-5 text-lg text-neutral-600">
              Manage customer conversations, quotes, products, and team workflows from one streamlined workspace.
            </p>
            ...
            <div className="kx-card2 p-5">
              ...
              <div className="mt-3 space-y-3">
                <div className="rounded-2xl border border-neutral-200 p-4">
                  <div className="font-medium">New enquiry: Sipho</div>
                  <div className="text-sm text-neutral-600">Wants pricing + delivery options.</div>
                </div>
                <div className="rounded-2xl border border-neutral-200 p-4">
                  <div className="font-medium">Workflow executed</div>
                  <div className="text-sm text-neutral-600">Pricing request matched an auto-reply rule.</div>
                </div>
                <div className="rounded-2xl border border-neutral-200 p-4">
                  <div className="font-medium">Quote delivered</div>
                  <div className="text-sm text-neutral-600">R2,499 proposal shared with the customer.</div>
                </div>
              </div>
            </div>
          </div>
