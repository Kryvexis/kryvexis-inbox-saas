            ...
            <div className="kx-card2 p-5">
              ...
              <div className="mt-3 space-y-3">
                ...
                <div className="rounded-2xl border border-neutral-200 p-4">
                  ...
                  <div className="text-sm text-neutral-600">Pricing request matched a reply workflow and follow-up was sent.</div>
                </div>
                <div className="rounded-2xl border border-neutral-200 p-4">
                  <div className="font-medium">Quote delivered</div>
                  <div className="text-sm text-neutral-600">R2,499 quote shared with the customer.</div>
                </div>
              </div>
            </div>
          </div>
