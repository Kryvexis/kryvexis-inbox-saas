...
import { getProfile, requireTenant, listAutomations } from "@/lib/data";
...
export default async function AutomationsPage() {
  ...
  const rules = await listAutomations(tenant.tenantId);
    ...
    <div className="grid gap-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="text-sm text-neutral-500">Keyword rules for instant replies (pre-API).</div>
        </div>
